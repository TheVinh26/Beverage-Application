...
import com.coffee.app.ui.forgot.ForgotPasswordActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    TextView tvErrorMessage, tvRegisterRedirect, tvForgotRedirect;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvForgotRedirect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void addControls() {
        ...
        tvForgotRedirect = findViewById(R.id.tvForgotRedirect);
    ...
    private void createUserAccountRequest(FirebaseUser userInfo) {
        ...
        GoogleSignInAccount signedInAccount = GoogleSignIn.getLastSignedInAccount(LoginActivity.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams() {
                ...
                param.put("email", userInfo.getEmail() != null ? userInfo.getEmail() : signedInAccount.getEmail());
