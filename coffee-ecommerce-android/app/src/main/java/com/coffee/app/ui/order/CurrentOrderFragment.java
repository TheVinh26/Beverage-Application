...
public class CurrentOrderFragment extends Fragment {
    ...
    private void showDetail() {
        chipOrderDetail.setEnabled(true);
        chipOrderDetail.setText("Xem chi tiết");
    ...
    private void getCurrentOrderRequest() {
        ...
        chipOrderDetail.setText("Đang tải...");
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    Toast.makeText(getContext(), "Đã tải dữ liệu đơn hàng", Toast.LENGTH_SHORT).show();
